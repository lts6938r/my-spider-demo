...
type Scheduler interface {
	...
	// 当前实现不阻塞也不取消。
	Pop(ctx context.Context) (*spider.Request, bool)
...
func (s *FIFOScheduler) Push(r *spider.Request) {
	if r == nil {
		return
	}
	s.mu.Lock()
...
func (s *FIFOScheduler) Pop(ctx context.Context) (*spider.Request, bool) {
...
func (s *PriorityQueueScheduler) Push(r *spider.Request) {
	if r == nil {
		return
	}
	s.mu.Lock()
...
func (s *PriorityQueueScheduler) Pop(ctx context.Context) (*spider.Request, bool) {
